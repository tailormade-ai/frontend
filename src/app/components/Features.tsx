...
const cardData: CardDataProps[] = [
  {
    ...
    content:
      "Connect your agents to your systems and let them perform tasks directly.",
    image:
  ...
  },
  {
    ...
    content:
      "Our agents are designed to learn and improve over time, becoming more efficient and effective as they work.",
    image:
  ...
  },
  {
    ...
    content:
      "Our agents can work together to perform complex tasks, such as data analysis and decision making.",
    image:
      ...
      <div className="py-14">
        <div className="container flex w-full flex-col items-center justify-center p-4">
          <div className="mx-auto max-w-5xl text-center">
            <h3 className="text-2xl font-bold tracking-tight text-black dark:text-white sm:text-4xl">
